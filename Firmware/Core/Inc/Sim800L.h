...
int8_t Sim_Bearer_Configure(void ); //-1 fault,  1: Config success             
int8_t Sim_Bearer_Dis(void ); // -1: couldn't disconnect, 1: disconnect OK
int8_t Sim_HTTP_Post(char * s); //-1: Fault, 1: Success 
