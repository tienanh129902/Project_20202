...
import kotlinx.android.synthetic.main.activity_get_routes.*
...
class GetRoutes : AppCompatActivity(), OnMapReadyCallback
        ...
        if (location != "") {
            ...
            if (addressList != null) {
                for (i in addressList.indices) {
                    ...
                    tvCurrentAddress!!.setText("Khoảng cách = $s KM")
...
// Drawing polyline in the Google Map for the i-th route
    ...
    private fun getDirectionsUrl(origin: LatLng, dest: LatLng): String? {
        ...
        val url = "https://maps.googleapis.com/maps/api/directions/$output?$parameters&key=AIzaSyDxrnYrr6xRhHbs_HYErA15eMqwBFBDMvs"
        return url
    }
...
//            mapView.getMapAsync(this@MainActivity)
            ...
            if (e.hasDenied()) {
                ...
                AlertDialog.Builder(this)
                    .setMessage("Hãy xác thực quyền truy cập")
    ...
    private fun getCurrentLocation() {
        fusedLocationProviderClient =
            LocationServices.getFusedLocationProviderClient(this@GetRoutes)
